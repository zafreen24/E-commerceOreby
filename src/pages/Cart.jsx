     ...
     <Container>
      ...
      {data.map((item, index)=>(
         ...
         <div className="flex w-[150px] h-[50px]  justify-around items-center mx-auto">
                         <div className="font-sans text-[20px] text-[#767676]" onClick={()=>productDecrement(index)}>-</div>
      ...
      <div className="flex justify-end">
       <div className="">
       <h2 className='font-sans text-[27px] font-bold text-[#262626] text-end'>Cart totals</h2>
        ...
        <div className="flex my-3 w-[400px] border-2 border-[#F0F0F0] justify-around">
          ...
          <div className="mt-2" onClick={handleCheckOut}>
            <p className='w-[220px] h-[50px] border-2 border-[#F0F0F0] bg-black text-[#ffffffcd]
              text-center leading-[50px]'>Proceed to Checkout</p>
          </div>
       </div>
      </div>
    <ToastContainer
