          ...
          <div className="">
            ...
            <Link to={`/product/${item.id}`}>
              ...
              <div className="w-full lg:h-[50%] bg-[#fff] absolute left-0 bottom-[-150px] lg:pt-[25px] pt-[10px] lg:pr-[30px] pr-[15px] flex flex-col lg:gap-y-2 gap-y-1 duration-500 ease-in-out group-hover:bottom-0">
                ...
                <div className="flex items-center justify-end gap-x-3">
                  <h3 onClick={handlePCart} className="text-[#767676] font-sans lg:text-[16px] text-[12px] font-normal hover:text-[#262626] hover:font-bold duration-300 ease-in-out">
                    Add to Cart
                  </h3>
                  <FaShoppingCart />
                </div>
        ...
        <div className="">
          <div className="relative overflow-hidden">
            ...
            <div className="w-full lg:h-[50%] bg-[#fff] absolute left-0 bottom-[-150px] lg:pt-[25px] pt-[10px] lg:pr-[30px] pr-[15px] flex flex-col lg:gap-y-2 gap-y-1 duration-500 ease-in-out group-hover:bottom-0">
              ...
              <div className="flex items-center justify-end gap-x-3">
                <h3 onClick={()=>handlePCart(item)} className="text-[#767676] font-sans lg:text-[16px] text-[12px] font-normal hover:text-[#262626] hover:font-bold duration-300 ease-in-out">
                  Add to Cart
                </h3>
                <FaShoppingCart />
              </div>
